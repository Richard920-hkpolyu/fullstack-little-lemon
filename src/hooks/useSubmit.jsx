...
const wait = (ms) => new Promise((resolve) => setTimeout(resolve, ms));//Promise represents the eventual completion or failure of an asynchronous operation.
//After 2 seconds, resolve is called, fulfilling the Promise.
const useSubmit = () => {
