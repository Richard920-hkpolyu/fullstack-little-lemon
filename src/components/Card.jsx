    ...
    return(
        ...
        >
            ...
            <VStack alignItems="start" width={{ base: "45vw", md: "100%" }}>
                <Image width={{ base: "45vw", md: "100%" }} maxWidth="300px" maxHeight="300px" height={{ base: "45vw", md: "100%" }} borderRadius="xl" src={imageSrc} alt={title} fit="cover" onClick={handleNavigate} loading="lazy" cursor="pointer"
