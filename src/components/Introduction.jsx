...
const Introduction = () => {
    const alignment = useBreakpointValue({//allows you to define responsive values that change based on the current viewport size (breakpoints).
        base: "center",//breakpoint=viewpoint size
        md: "center",
        lg: "start",
    });
    ...
    return (
        <>
            <FullScreenSection
                ...
                backgroundImage={`url(${img1})`}//url():proper syntax for specifying background images in CSS
                backgroundSize="cover"//covers the entire element while maintaining its aspect ratio
                backgroundPosition="center"
                borderRadius="md"
                minHeight={{ base: "50vh", md: "570px" }}
                zIndex="100"
                width={{ base: "96vw", md: "96vw", lg: "96vw" }}
            >
                    <br /><br />
                    <VStack
