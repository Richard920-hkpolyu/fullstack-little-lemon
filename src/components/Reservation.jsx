...
const getCurrentDate = () => {
    ...
    const day = String(today.getDate()).padStart(2, '0');//padded with '0' to ensure its total length is 2. If the original string is already 2 characters or longer, it remains unchanged.
